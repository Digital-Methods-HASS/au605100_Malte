...
Becasue the variable 'gdpPercap' contains hard skewness, meaning that some values are very large, log10 allows us to get a better view of the data.
...
anim7
```
Not very intuitive i know, but it looks cool :)))
