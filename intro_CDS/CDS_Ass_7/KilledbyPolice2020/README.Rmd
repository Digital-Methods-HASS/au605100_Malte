...
Next, you can develop further
(2) homicides.Rmd, which has a similar workflow, but surveys FBI and wikipedia data on homicide incidence per state in the US for the last decade. This script is unfinished and needs TLC.
